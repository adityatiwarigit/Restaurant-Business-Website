...
<head>
    ...
    <style>
        * {
        ...
        .other {
            width: 60%;
            background-image: url("../Restaurant Management/assets/images/portfolio/front.jpg");
                ...
                <div class="contact">
                    <div class="other">
                        <div class="info">
                            ...
                            <h3>Email</h3>
                            <div class="svg-wrap">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.211 485.211">
                            ...
                            <h3>Connect</h3>
                            <div class="svg-wrap">
                                <a href="http://instagram.com/connorgaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                <a href="http://twitter.com/connor_gaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 612 612">
                                ...
                                <a href="http://facebook.com/connorgauntdesign" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="60.734" height="60.733" viewBox="0 0 60.734 60.733">
                                ...
                                <a href="http://linkedin.com/in/connorgaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 478.165 478.165">
                    ...
                    <div class="form">
                        ...
                        <form action="">
                            <div class="flex-rev">
                                <input type="text" placeholder="Tom Cruiz" name="name" id="name" />
                            ...
                            <div class="flex-rev">
                                ...
                                <label for="message">Drop Message</label>
                            </div>
    ...
    <section id="footer" style="background-color:black;height:100px">
        <div id="footer-content">
            ...
            <div class="footer-center">
                ...
                <a href="https://twitter.com/AdityaT84114977"><img class="footer-center-2" src="../Restaurant Management/assets/images/Twitter.svg" alt="Twitter"></a>
